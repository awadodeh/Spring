package com.owdaawad.services.reservation;
...
public class ReservationServicesApplication {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("Reservations").select()
                .apis(RequestHandlerSelectors.basePackage("com.owdaawad.services.reservation"))
                .paths(any()).build().apiInfo(new ApiInfo("Reservation Services",
                        ...
                        new Contact("Awad Owda", "https://facebook.com/awad.odeh2", null), null, null));
    }
}
